package csu.wsq.backendtemplate.service.impl;
...
import csu.wsq.backendtemplate.common.utils.SqlUtils;
import csu.wsq.backendtemplate.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "doubao";
    private static final String USER_LOGIN_STATE = "user_login";
    public static final String USER_ROLE_VALUE = "admin";
...
//    }
     ...
     */
    @Override
    public User getLoginUserPermitNull(HttpSession session) {
        // 先判断是否已登录
        Object userObj = session.getAttribute(USER_LOGIN_STATE);
        User currentUser = (User) userObj;
        if (currentUser == null || currentUser.getId() == null) {
    ...
    public boolean isAdmin(User user) {
        return user != null && USER_ROLE_VALUE.equals(user.getUserRole());
    }
